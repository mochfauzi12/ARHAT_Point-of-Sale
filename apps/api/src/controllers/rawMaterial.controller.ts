...
export const getRawMaterials = async (c: Context) => {
...
export const createRawMaterial = async (c: Context) => {
  const tenantId = c.get('tenantId');
...
export const updateRawMaterial = async (c: Context) => {
...
export const deleteRawMaterial = async (c: Context) => {
  const id = c.req.param('id');
  const tenantId = c.get('tenantId');
...
export const getProductBoms = async (c: Context) => {
...
export const updateProductBom = async (c: Context) => {
  const productId = c.req.param('productId');
