...
export class WhatsAppService {
   ...
   */
  static async sendReceipt(tenantId: string, phone: string, transaction: any) {
    if (!phone) return;
...
Semoga harimu menyenangkan!`;
   ...
   */
  static async sendLowStockAlert(tenantId: string, phone: string, productName: string, remainingStock: number) {
    if (!phone) return;
   ...
   */
  static async sendNotification(tenantId: string, phone: string, message: string) {
    if (!phone) return;
   ...
   */
  static async processMessage(messageId: string) {
